...
The `v0.1.0` release and earlier copies validly distributed under MIT retain the rights granted by MIT. The current policy does not revoke those grants. See `LICENSE_HISTORY.md` for the exact pre-boundary commit.
